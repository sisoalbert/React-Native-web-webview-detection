...
class App extends Component {
  isWebView() {
    ...
    const isWebViewAndroid = /; wv/i.test(userAgent);
    const isWebViewiOS = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(
      userAgent
    );
  ...
  render() {
    const isUiwebviewiOS = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(
      navigator.userAgent
    );
    const isUiwebviewiAndroid = /; wv/i.test(navigator.userAgent);
    const isUiwebview = isUiwebviewiOS || isUiwebviewiAndroid;
    return (
      <View style={styles.app}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>
            isUiwebview: {isUiwebview.toString()}
          </Text>
        </View>
